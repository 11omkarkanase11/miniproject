...
export default function CardComponent({uname,uid}) {
    ...
    return (
        <div className="mt-4 flex justify-between items-center m-auto w-1/2 h-56 rounded-lg shadow-lg border-2 border-grey-400 hover:cursor-pointer hover:border-slate-600" >
            <div>
            <img
