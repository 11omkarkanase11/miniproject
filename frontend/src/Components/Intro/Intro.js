...
const Intro=()=>{
    ...
    return(
        <div className="bg-gradient-to-r from-orange-500 to-yellow-500">
            ...
            {<Steps />}
            <h1 id="page_sec" className="text-center text-7xl font-bold">Who are you??</h1>
            <div className="flex items-center w-full p-8 pt-16">
                <div className="flex w-full justify-around items-center px-12 py-4">
                    <div className="text-center shadow-2xl shadow-black px-16 py-6 pb-8 rounded-xl">
            ...
            <div className="pt-16 pb-2 text-center font-bold flex items-center w-full">
                <span className="block m-auto text-lg">@T_E_A_M__A_A_M_H_I__J_O_R_A_A_T</span>
            </div>
        </div>
    )
}
